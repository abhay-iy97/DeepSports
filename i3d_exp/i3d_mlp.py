...
def load_dataset(annotations: Annotation) -> Tuple[DataLoader, DataLoader, DataLoader]:
    ...
    train_data_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=10, persistent_workers=True, pin_memory=True)
    val_data_loader = DataLoader(val_dataset, batch_size=batch_size, shuffle=True, num_workers=10, persistent_workers=True, pin_memory=True)
    test_data_loader = DataLoader(test_dataset, batch_size=batch_size, shuffle=False, num_workers=10, persistent_workers=True, pin_memory=True)
...
def plot_losses(train_losses: List[float], val_losses: List[float], val_spearman_correlations: List[float]) -> None:
    ...
    plt.show()
    plt.savefig("/scratch1/bodala/new18.png")
...
def main():
    ...
    print("new18.txt")
    f = open("/scratch1/bodala/new18.txt", "a")
    ...
    #f.write(m.summary)
    f.close()
    torch.save(m, "/scratch1/bodala/new18.pth")
